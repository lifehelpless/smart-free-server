...
public class OrderService {
    ...
    public String createBizOrder(OrderAddForm addForm) {
        ...
        // 0-待支付 (通常定义在枚举类中，如 OrderStatusEnum.WAIT_PAY.getCode())
    ...
    public OrderEntity selectOne(LambdaQueryWrapper<OrderEntity> queryWrapper) {
        return orderDao.selectOne(queryWrapper);
    }

    public int updateById(OrderEntity order) {
