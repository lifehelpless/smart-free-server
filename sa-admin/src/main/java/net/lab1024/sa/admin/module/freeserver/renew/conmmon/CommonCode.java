...
import net.lab1024.sa.admin.module.freeserver.renew.constant.CloudDataKey;
import net.lab1024.sa.admin.module.freeserver.renew.constant.CloudPostParams;
...
public class CommonCode {
    ...
    public static void checkCheckStatus(JSONObject json, String ukLog, String blogUrl, MailUtil mailUtil) throws Exception {
        ...
        JSONArray array = JSONUtils.getArray(json, CloudDataKey.CHECK_DATA);
        if(array.size()>0){
    ...
    public static boolean isInitBlog(String blogUrl) throws IOException {
        ...
        if (pubHeader != null && !pubHeader.isEmpty()) {
            for (Map.Entry<String, String> entry : pubHeader.entrySet()) {
