package net.lab1024.sa.admin.module.freeserver.instance.controller;

import net.lab1024.sa.admin.module.freeserver.instance.domain.form.UserCloudServerAddForm;
import net.lab1024.sa.admin.module.freeserver.instance.domain.form.UserCloudServerQueryForm;
import net.lab1024.sa.admin.module.freeserver.instance.domain.form.UserCloudServerUpdateForm;
import net.lab1024.sa.admin.module.freeserver.instance.domain.vo.UserCloudServerVO;
import net.lab1024.sa.admin.module.freeserver.instance.service.UserCloudServerService;
